---
name: impl
description: Use when starting implementation. The main agent plans, supervises, reviews strictly, and delegates simple or scoped work to subCLAUDE when available.
---
